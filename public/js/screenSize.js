window.mobileAndTabletCheck = function() {//from detectmobilebrowsers.com
    let check = false;
...
$('#inputBar').focusin(function(){
    if (isMobile){
        $('#background-small').css("display", "none");
        $('#background-mobile').css("display", "block");
        $('#background-large').css("width", "100px");
        $('#background-large').css("margin-left", "auto");
        $('#background-large').css("margin-right", "auto");
...
$('#inputBar').focusout(function(){
    if (isMobile){
        $('#background-small').css("display", "block");
