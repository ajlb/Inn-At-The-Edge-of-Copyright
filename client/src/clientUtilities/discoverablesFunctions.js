...
function unlockDoor({ setChatHistory }) {
    setTimeout(() => {
        if (hasStartKey) {
...
function openWardrobe({ setChatHistory }) {
    setTimeout(() => {
        if (wardrobeIsOpen) {
...
function startRoomLook({ setChatHistory, location }) {
...
function startRoomGet({ setChatHistory, input }) {
...
function startRoomInventory({ setChatHistory }) {
...
function startRoomMove({ socket, input, location, user, playerPosition, setChatHistory, actionCalls }) {
