import Finders from "../js/finders";
...
function juggle(value){
    ...
    value = Finders.takeTheseOffThat(actionCalls.juggle, value);
        ...
        if (numbers[prop].includes(num.toLowerCase())){
            ...
            if (typeof num === "number" && num > 2){  
                ...
                getInventory(currentUserId).then(userInventory => {
                    Finders.findMatchByItemName(pluralize(target, 1), userInventory).then(matchSuccess=>{
