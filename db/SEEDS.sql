...
("talk to", "talk to an NPC", "When you type 'talk to' followed by the name of an NPC in your location, you will be able to interact with them.", "talk to, address", "talk to clerk", " "),
