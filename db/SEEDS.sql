...
VALUES
    ...
    (1122, "Tree Tunnel North", "The tunnel of trees you find yourself in is lined with dark trees. There seems to be a clearing in the trees up ahead to the north. The tunnel of trees continues to the south.", "Tree Tunnel North", "The tunnel of trees you find yourself in is lined with dark trees. There seems to be a clearing in the trees up ahead to the north. The tunnel of trees continues to the south.", 1121, Null, 1123, Null, "Halloween"),
